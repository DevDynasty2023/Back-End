...
public class AuthorizeTutorAttribute : Attribute, IAuthorizationFilter
{
    public void OnAuthorization(AuthorizationFilterContext context)
    {
        ...
        else
        {
            ...
            if (user == null || user.Role.Name == "Aprendiz" ) //If there is no user or the user has role of Aprendiz
